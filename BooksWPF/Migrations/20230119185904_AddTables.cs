    ...
    public partial class AddTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SavedBooksId = table.Column<int>(type: "int", nullable: false),
                    SavesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookSave", x => new { x.SavedBooksId, x.SavesId });
                    table.ForeignKey(
                        name: "FK_BookSave_Books_SavedBooksId",
                        column: x => x.SavedBooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookSave_Saves_SavesId",
                        column: x => x.SavesId,
                        principalTable: "Saves",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookSave_SavesId",
                table: "BookSave",
                column: "SavesId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_SaveId",
                table: "Users",
                column: "SaveId",
                unique: true);
        }
